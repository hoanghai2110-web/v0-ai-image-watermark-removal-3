...
export async function POST(req: NextRequest) {
  try {
    ...
    console.log("[v0] Webhook received:", { eventName, customData })
    ...
    if (eventName === "order_created") {
      ...
      console.log("[v0] Processing order_created:", { userId, orderTotal })
      ...
      if (userId) {
        ...
        if (profileError) {
          ...
          console.log("[v0] User marked as premium from order:", userId)
        }
